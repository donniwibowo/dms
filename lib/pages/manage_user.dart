...
class _ManageUserState extends State<ManageUser> with TickerProviderStateMixin {
  ...
  Future<List<UserModel>>? _fetchUser(String folder_id, String type) async {
    ...
    var url =
        'https://192.168.1.17/leap_integra/master/dms/api/files/getuseraccessbyfolder?user_token=' +
            user_token +
            '&folder_id=' +
            folder_id;
                                ...
                                ElevatedButton(
                                    onPressed: () async {
                                      ...
                                      var response = await http.post(
                                          "https://192.168.1.17/leap_integra/master/dms/api/files/manageuseraccess?user_token=" +
                                              user_token!,
                                          body: data);
                                                  ...
                                                  Container(
                                                    child: IconButton(
                                                        onPressed: () async {
                                                          ...
                                                          var response =
                                                              await http.post(
                                                                  "https://192.168.1.17/leap_integra/master/dms/api/files/deleteuseraccess?user_token=" +
                                                                      user_token!,
                                                                  body: data);
