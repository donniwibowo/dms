...
class _RelatedDocumentState extends State<RelatedDocument> {
  ...
  Future<List<CategoryModel>>? _fetchDocument() async {
    ...
    final response = await http.get(Uri.parse(
        'https://192.168.1.17/leap_integra/master/dms/api/files/getrelateddocumentbyuser?user_token=' +
            user_token));
                                ...
                                IconButton(
                                    onPressed: () async {
                                      ...
                                      var response = await http.post(
                                          "https://192.168.1.17/leap_integra/master/dms/api/files/addrelateddocument?user_token=" +
                                              user_token!,
                                          body: data);
                                                    ...
                                                    child: PopupMenuButton<
                                                        ...
                                                        onSelected:
                                                          ...
                                                          if (value ==
                                                            ...
                                                            var response =
                                                                await http.post(
                                                                    "https://192.168.1.17/leap_integra/master/dms/api/files/deleterelateddocument?user_token=" +
                                                                        user_token!,
                                                                    body: data);
